...
const firearmCategories = {
    ultraCompactPistol: {
        ...
        image: "ultra_compact_pistol.jpg",
    ...
    ultraLightRevolver: {
        ...
        image: "ultra_light_revolver.jpg",
    ...
    compactReliablePistol: {
        ...
        image: "compact_reliable_pistol.jpg",
    ...
    premiumCompactPistol: {
        ...
        image: "premium_compact_pistol.jpg",
    ...
    highCapacityPistol: {
        ...
        image: "high_capacity_pistol.jpg",
    ...
    modernFeatureRevolver: {
        ...
        image: "modern_feature_revolver.jpg",
        explanation: "Modern feature revolvers blend traditional revolver reliability with contemporary enhancements. They're perfect for those who appreciate revolver simplicity but want modern improvements like optics compatibility."
    }
};
...
function showResults() {
    ...
    document.getElementById('primary-description').innerText = 
        `${firearmCategories[primaryCategory].description}\n\nRecommended models: ${firearmCategories[primaryCategory].examples.join(', ')}`;
    ...
    document.getElementById('secondary-description').innerText = 
        `${firearmCategories[secondaryCategory].description}\n\nRecommended models: ${firearmCategories[secondaryCategory].examples.join(', ')}`;
    
    // Set placeholder images (in a real implementation, these would be actual images)
